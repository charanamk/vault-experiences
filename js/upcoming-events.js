...
(function () {
    ...
    function fillUpcomingCard(event, savedEvents) {
        ...
        const image =
            card.querySelector(".event-image");
        ...
        const theme =
            card.querySelector(".event-theme");

        const description =
            card.querySelector(".event-description p");

        const location =
            card.querySelector(".event-location");
    ...
    function renderEvents() {
        ...
        const savedEvents =
            ...
            typeof window.VaultWishlist.get === "function"
                ? new Set(
                    window.VaultWishlist
                        .get()
                        .map(
    ...
    document.addEventListener(
        ...
        (event) => {
            ...
            if (
                ...
                if (
                    window.VaultWishlist &&
                    typeof window.VaultWishlist.toggle ===
                        "function"
                ) {
                    event.preventDefault();

                    window.VaultWishlist.toggle(
                        eventId
                    );
